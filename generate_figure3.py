...
accuracy = [0.8967, 0.8937, 0.8972, 0.8754, 0.8748, 0.8702, 0.8648]  # 表4数据
gap = [0.1033, 0.1031, 0.1028, 0.0932, 0.0937, 0.0985, 0.1045]  # 表6数据

# 颜色：基线蓝色，AdaPrune红色/绿色
...
# 图(a): 测试准确率对比
ax1 = axes[0]
bars1 = ax1.bar(methods, accuracy, color=colors_acc, edgecolor='black', linewidth=0.5)
ax1.set_ylabel('Accuracy', fontsize=12)
ax1.set_title('(a) Test Accuracy Comparison', fontsize=12)
ax1.set_ylim(0.84, 0.92)
ax1.axhline(y=0.89, color='orange', linestyle='--', linewidth=1, alpha=0.7)
...
# 图(b): 泛化差距对比
ax2 = axes[1]
bars2 = ax2.bar(methods, gap, color=colors_gap, edgecolor='black', linewidth=0.5)
ax2.set_ylabel('Generalization Gap', fontsize=12)
ax2.set_title('(b) Generalization Gap Comparison', fontsize=12)
ax2.set_ylim(0, 0.14)
ax2.axhline(y=0.10, color='orange', linestyle='--', linewidth=1, alpha=0.7, label='0.10 threshold')
